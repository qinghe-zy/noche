...
interface RemoveDraftOptions {
  cleanupManagedFiles?: boolean;
}
...
export const useDraftStore = defineStore("draft", {
  ...
  actions: {
    ...
    async removeDraft(slotKey: string, options: RemoveDraftOptions = {}): Promise<void> {
      this.isLoading = true;
      this.error = null;
      ...
      try {
        ...
        if (options.cleanupManagedFiles !== false) {
