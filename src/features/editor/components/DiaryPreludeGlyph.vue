<template>
  ...
  >
    <template v-if="kind === 'weather'">
      <template v-if="resolvedCode === 'sunny'">
        <path d="M12 3.5V6.2" />
      ...
      <template v-else-if="resolvedCode === 'cloudy'">
      ...
      <template v-else-if="resolvedCode === 'rainy'">
    ...
    <template v-else>
      ...
      <template v-if="resolvedCode === 'joyful'">
      ...
      <template v-else-if="resolvedCode === 'anxious'">
      ...
      <template v-else-if="resolvedCode === 'relieved'">
...
.diary-prelude-glyph path,
.diary-prelude-glyph circle {
  stroke: currentColor;
  stroke-width: 1.6;
