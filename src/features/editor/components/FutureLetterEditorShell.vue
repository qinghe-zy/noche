...
.editor-page__paper-surface { width: 100%; max-width: none; min-height: var(--noche-content-min-height); padding: 0 var(--noche-page-padding-x) var(--noche-page-bottom-padding); background: linear-gradient(180deg, var(--noche-paper-1), var(--noche-paper-2)); border: none; box-shadow: none; display: flex; flex-direction: column; position: relative; }
.editor-page__topbar { width: 100%; margin-bottom: 0; flex-shrink: 0; }
.editor-page__topbar-inner { width: 100%; min-height: var(--noche-nav-bar-height); padding: var(--noche-status-bar-height) var(--noche-topbar-padding-x) 0; display: flex; align-items: center; justify-content: space-between; }
.editor-page__topbar-button { width: 72rpx; height: 72rpx; padding: 0; display: flex; align-items: center; justify-content: center; position: relative; color: var(--noche-ink-faint); border: none; background: transparent; }
...
.editor-page__body { padding-top: var(--noche-page-section-gap-tight); }
.editor-page__body-fill { gap: 0; }
...
.editor-page__writing-area { flex: 1; min-height: 0; display: flex; flex-direction: column; padding-top: 8px; }
.editor-page__textarea,.editor-page__read-content { width: 100%; flex: 1; border: none; color: var(--noche-ink-strong); font-size: 18px; padding-right: 8px; padding-bottom: 0; padding-left: 8px; overflow-wrap: anywhere; }
...
.editor-page__attachment-toolbar { display: flex; justify-content: flex-start; padding: 16rpx 8px 0; }
...
.editor-page__seal { align-self: flex-end; margin-top: 12rpx; pointer-events: none; }
