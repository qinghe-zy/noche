...
.type-scale-small .profile-album-viewer__close-text,
.type-scale-small .profile-album-viewer__type { font-size: 18rpx; }
.type-scale-large .profile-album-viewer__counter,
.type-scale-large .profile-album-viewer__close-text,
.type-scale-large .profile-album-viewer__type { font-size: 21rpx; }
.type-scale-small .profile-album-viewer__date { font-size: 26rpx; }
.type-scale-large .profile-album-viewer__date { font-size: 31rpx; }
.type-scale-small .profile-album-viewer__jump-text { font-size: 23rpx; }
.type-scale-large .profile-album-viewer__jump-text { font-size: 26rpx; }
</style>
