...
describe("profileData", () => {
  ...
  it("formats profile labels with warm lightweight copy", () => {
    ...
    expect(formatProfileBackupLabel(null, "zh-CN")).toBe("尚未备份");
    expect(formatProfileBackupLabel("2026-04-11T09:30:00.000Z", "zh-CN")).toBe("最近一次 2026.04.11 17:30");
  ...
  it("limits the home profile album strip to four recent images", () => {
    expect(PROFILE_PREVIEW_LIMIT).toBe(4);
  });
});
